    ...
    <div className="overflow-x-hidden">
        ...
        <div className="relative z-10 max-w-screen-xl mx-auto px-6 w-full pt-[var(--navbar-h)]">
          <div className="max-w-3xl">
            ...
            <motion.p
              ...
              className="text-base text-white/70 mt-6 max-w-xl leading-relaxed"
            >
              Redcat® Eyewear isn't just about style. It's about unlocking vision that goes beyond what the human eye typically sees. Powered by advanced color-tuned lens technology, Redcat amplifies select color wavelengths to make colors more vivid, vibrant, and alive. The result is sharper acuity, heightened clarity, and a true performance advantage in high-velocity sports and everyday life.
            </motion.p>
      ...
      <section data-testid="colorboost-section" className="grid lg:grid-cols-2 min-h-[600px]">
        ...
        >
          ...
          <p className="text-gray-600 dark:text-white/55 text-sm leading-relaxed mb-8 max-w-md">
          ...
          <div className="flex items-center gap-6 mb-8">
            {[["Up to 37%", "Color-tuned"], ["UV400", "Full spectrum"], ["Lifetime", "Warranty"]].map(([val, label]) => (
              <div key={label}>
                ...
                <p className="text-[10px] text-gray-400 dark:text-white/35 uppercase tracking-widest mt-1">{label}</p>
              </div>
            ))}
          </div>
          <Link
      ...
      <section data-testid="products-section" className="py-24 px-6 max-w-screen-xl mx-auto">
        ...
        >
          <div>
            ...
            <p className="text-gray-500 dark:text-white/40 text-sm mt-2">On the Court, Course, Water, Road, or Trail</p>
          </div>
          <Link
            to="/collections"
            data-testid="view-all-products"
            className="inline-flex items-center gap-2 text-xs font-bold tracking-widest uppercase text-gray-500 dark:text-white/45 hover:text-gray-900 dark:hover:text-white transition-colors"
          >
            ...
            >
              ...
              >
                ...
                <div className="p-5 border-t border-black/5 dark:border-white/8">
                  <p className="text-[10px] text-gray-400 dark:text-white/35 tracking-widest uppercase mb-1">Redcat Eyewear</p>
      ...
      <section data-testid="manifesto-section" className="bg-[#FAFAFA] dark:bg-rc-surface py-24 px-6">
        <div className="max-w-screen-xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-0 border-t border-black/10 dark:border-white/10">
            {CHAPTERS.map((c, i) => (
              <motion.div
                key={c.num}
                ...
                whileInView="visible"
                viewport={{ once: true, margin: "-60px" }}
                className="border-b md:border-b-0 md:border-r border-black/10 dark:border-white/10 last:border-r-0 px-0 md:px-8 py-10 first:pl-0 last:pr-0"
              >
                <span className="font-display text-[6rem] font-black text-black/5 dark:text-white/6 leading-none block mb-2">{c.num}</span>
                <h3 className="font-display text-lg font-black uppercase tracking-widest text-gray-900 dark:text-white mb-4">{c.title}</h3>
                <p className="text-sm text-gray-500 dark:text-white/45 leading-relaxed">{c.body}</p>
              </motion.div>
            ))}
          </div>
          ...
          >
            <img src={ROAR_FLOAT} alt="Redcat ROAR floating" className="w-full h-full object-contain bg-white dark:bg-rc-surface" />
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-screen-xl mx-auto">
          <div className="max-w-xl mx-auto text-center">
            ...
            >
              ...
              <h2
                className="font-display font-black uppercase leading-tight text-gray-900 dark:text-white mt-2 mb-4"
                style={{ fontSize: "clamp(2rem, 4vw, 3rem)" }}
              >
                Join the Redcat<br />Coalition
              </h2>
              <p className="text-gray-500 dark:text-white/45 text-sm mb-8">New products, sales, restocks, and exclusive offers.</p>
              <NewsletterForm />
            </motion.div>
          </div>
        </div>
  ...
  return (
    ...
    >
      <input
        ...
        className="flex-1 bg-white dark:bg-rc-dark border border-black/15 dark:border-white/15 px-5 py-4 text-sm text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-white/25 focus:outline-none focus:border-rc-cyan transition-colors"
      />
      <button
        type="submit"
        data-testid="newsletter-submit"
        className="bg-rc-red text-white px-7 py-4 text-xs font-bold tracking-widest uppercase hover:bg-gray-900 dark:hover:bg-white dark:hover:text-rc-red transition-colors duration-200 whitespace-nowrap"
      >
        Subscribe
      </button>
    </form>
